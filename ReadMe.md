# <span style="color:#0ec2b8">_Martian project_</span>

#### _Martian app, 10/23/2020_

#### By _**Nataliya Zhuravleva**, Riley McAdoo_

## <span style="color:#0ec2b8">Description</span>

_An application for Martians which includes Martian weather, the astronomy picture of the day, and views from the Mars Rover._
